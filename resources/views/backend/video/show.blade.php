...
@section('content')
    <div class="py-4">
        ...
        <div class="mb-3 mb-lg-0">
            ...
            <p class="mb-0">Lihat Detail Video Yummy Restaurant</p>
        </div>
        <div>
    ...
    <div class="card border-0 shadow mb-4">
        <div class="card-body">
            <table class="table table-striped">
                ...
                <tr>
                    <th>Created At</th>
                    <td>: {{ date('d-m-Y H:i:s', strtotime($video->created_at . ' +7 hours')) }}</td>
                </tr>
                <tr>
                    <th>Updated At</th>
                    <td>: {{ date('d-m-Y H:i:s', strtotime($video->updated_at . ' +7 hours')) }}</td>
                </tr>
            </table>

            <div class="float-end mt-2">
                <a href="{{ route('panel.video.edit', $video->uuid) }}" class="btn btn-warning"><i
