                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="name" type="text"
                                        ...
                                        value="{{ old('name') }}" placeholder="{{ __('Your Name') }}" required autocomplete="name" autofocus>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="email" type="email"
                                        ...
                                        value="{{ old('email') }}" placeholder="{{ __('Your Email') }}" required autocomplete="email">
                                ...
                                {{-- <div class="mb-4">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label fw-normal mb-0" for="remember">
                                            {{ __('I agree to the') }} <a href="#" class="fw-bold">{{ __('terms and conditions') }}</a>
                                        </label>
                                    </div>
                                </div> --}}
                            </div>
