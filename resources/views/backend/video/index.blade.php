            ...
            <table class="table table-centered table-hover table-nowrap mb-0 rounded">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="{{ route('panel.video.show', $video->uuid) }}" class="btn btn-sm btn-info"><i
                                        class="fas fa-eye"></i></a>
                                <a href="{{ route('panel.video.edit', $video->uuid) }}"
                                    class="btn btn-sm btn-primary"><i class="fas fa-pencil-alt"></i></a>
                                <button class="btn btn-sm btn-danger" onclick="deleteVideo(this)"
